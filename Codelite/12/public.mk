...
SOPCINFO_FILE := /home/engineer/nios_tst/unsaved.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x3050
SOPC_SYSID_FLAG += --sidp=0x3050
ELF_PATCH_FLAG  += --sidp 0x3050

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1506929687
SOPC_SYSID_FLAG += --timestamp=1506929687
ELF_PATCH_FLAG  += --timestamp 1506929687

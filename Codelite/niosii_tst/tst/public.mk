...
SOPCINFO_FILE := C:/work/fpga/nios_fast+led+cancycloneiv_os/canios.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x13070
SOPC_SYSID_FLAG += --sidp=0x13070
ELF_PATCH_FLAG  += --sidp 0x13070

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1505201312
SOPC_SYSID_FLAG += --timestamp=1505201312
ELF_PATCH_FLAG  += --timestamp 1505201312
